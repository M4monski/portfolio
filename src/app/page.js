  ...
  return (
    <div className="w-full h-full scroll-smooth ">
      ...
      <div className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <main className="flex md:flex-row flex-col w-screen md:max-w-4/5 mx-auto py-4 h-screen items-center justify-center ">
          {/* LEFT AREA */}
          <div className="w-3/5 md:order-1 order-2 border-2 bg-white/20 rounded-4xl p-8">
            ...
            <p className="text-[20px] mt-2">
              ...
              foundational experience in C# and .NET. I love transforming
              designs into reality and continuously learning to overcome new
              hurdles. Proficient in React.js, Next.js, JavaScript/TypeScript,
              HTML, CSS/Tailwind, Node.js, and Firebase, I'm committed to
      ...
      <div className="bg-white">
        <main className="w-screen md:max-w-4/5 h-screen">
          <h1 className="text-black">Technology Stack</h1>
        </main>
      </div>

      {/* EXPERIENCE */}
      <div className="bg-white">
        <main className="w-screen md:max-w-4/5 h-screen"></main>
      </div>
